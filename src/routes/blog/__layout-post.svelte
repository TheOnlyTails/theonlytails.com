<script context="module" lang="ts">
  ...
  import type { BlogPost, PostData } from "$lib/data/types"
  ...
  export const load: Load = async ({ fetch, url }) => {
    ...
    const postMetadata: PostData = path !== "/blog" ? await fetch(`${ path }@post.json`).then(r => r.json()) : null
...
<style lang="scss">
	...
	@use "src/styles/syntax-highlighting";
	@use "src/styles/markdown-hints";
